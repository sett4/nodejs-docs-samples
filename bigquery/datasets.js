...
cli
  ...
  .command('create <name>', 'Create a new dataset.', {}, function (options) {
    program.createDataset(options.name, options.projectId, console.log);
  })
  .command('delete <datasetId>', 'Delete the specified dataset.', {}, function (options) {
    program.deleteDataset(options.datasetId, options.projectId, console.log);
  })
  .command('list', 'List datasets in the authenticated project.', {}, function (options) {
    program.listDatasets(options.projectId, console.log);
  })
  .command('size <datasetId>', 'Calculate the size of the specified dataset.', {}, function (options) {
    program.getDatasetSize(options.datasetId, options.projectId, console.log);
  })
  .option('projectId', {
    alias: 'p',
    requiresArg: true,
